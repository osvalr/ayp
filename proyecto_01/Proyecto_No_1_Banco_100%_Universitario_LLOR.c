...
pres()
{
    do
    {
        ...
        printf(CAZ"\t\t\t                  ,i"CAZ"i3X;"CB";"CAZ"rrr&#"CB
               "H,     ,;i:                               ,  &@@@@@X ,@@,\n");
...
monto(float* m)
{
    ...
    do
    {
        ...
        while ((p == 1 && bb != 1 && bb != 2) || (p == 0 && strlen(v) > 10) || pp == 0
               || p > 1);
    }
    while (b > 0);
    ...
    do
    {
        do
        {
            do
            {
                ...
                while (strncmp(&f[2], "\x2F", 1) != 0 && strncmp(&f[5], "\x2F", 1) != 0
                       && strncmp(&f[2], "\x2D", 1) != 0 && strncmp(&f[5], "\x2D", 1) != 0);
            }
        ...
        *di = atoi(dm);
        ...
        if (*an >= 1994 && *an <= z)
        {
            if (*me == 2 && *di >= 30 && (*an == 1996 || *an == 2000 || *an == 2004
                                          || *an == 2008))
            {
            ...
            if (*me == 2 && *di >= 1 && *di <= 29 && (*an == 1996 || *an == 2000
                    || *an == 2004 || *an == 2008))
            {
                b += 1;
            }

            if (*me == 2 && *di >= 29 && (*an != 1996 && *an != 2000 && *an != 2004
                                          && *an != 2008))
            {
            ...
            if (*me == 2 && *di >= 1 && *di <= 28 && (*an != 1996 && *an != 2000
                    && *an != 2004 && *an != 2008))
            {
                b += 1;
            }
        ...
        if (*me >= 1 && *me <= 12)
        {
            ...
            if ((*me == 4 || *me == 6 || *me == 9 || *me == 11) && *me != 2 && *di >= 1
                && *di <= 30)
            {
                b += 1;
            }
...
nocta(char ccta[])
{
    ...
    do
    {
        do
        {
            ...
            if (strncmp(&ccta[4], "\x2D", 1) == 0 && strncmp(&ccta[9], "\x2D", 1) == 0
                && strncmp(&ccta[12], "\x2D", 1) == 0)
            {
                t = 1;
            }
...
Archivo_Cuentas(cuenta v[], int* c)
{
    ...
    {
        printf(ST LC
               RES"\t\t\tNo Encuentro el archivo solicitado para trabajar \"Cuentas.in\""CB
               LC"\n\n\n");
    }
    ...
    else
    {
        *c = 0;
        ...
        while (feof(cuentas) == 0)
        {
            ...
            fscanf(cuentas, "%d\x2F%d\x2F%d", &v[*c].faper.dia, &v[*c].faper.mes,
                   &v[*c].faper.ano);
            fscanf(cuentas, "%d\x2F%d\x2F%d", &v[*c].fupi.dia, &v[*c].fupi.mes,
                   &v[*c].fupi.ano);
            fscanf(cuentas, " %s", v[*c].csuc);
            CD(v[*c].faper.dia, v[*c].faper.mes, v[*c].faper.ano, v[*c].fupi.dia,
               v[*c].fupi.mes, v[*c].fupi.ano, &cant);
...
Archivo_Sucursal(rsucursal v[], int* c)
{
    ...
    {
        printf(ST LC
               RES"\t\t\tNo Encuentro el archivo solicitado para trabajar \"Sucursales.in\""CB
               LC"\n\n\n");
    }
...
Archivo_Clientes(cliente v[], int* c)
{
    ...
    {
        printf(ST LC
               RES"\t\t\tNo Encuentro el archivo solicitado para trabajar \"Clientes.in\""CB
               LC"\n\n\n");
    }
...
Archivo_Transaccion(transaccion v[], int* c)
{
    ...
    {
        printf(ST LC
               RES"\t\t\tNo Encuentro el archivo solicitado para trabajar \"Transacciones.in\""CB
               LC"\n\n\n");
    }
    ...
    else
    {
        *c = 0;
        ...
        while (!feof(transacciones))
        {
            ...
            fscanf(transacciones, "%d\x2F%d\x2F%d", &v[*c].ftrans.dia, &v[*c].ftrans.mes,
                   &v[*c].ftrans.ano);
            ...
            transaccion x[], int d)
{
    ...
    for (i = 0; i < c; i++) ///RECORRE EL VECTOR DE REGISTROS DE CUENTAS
    {
        ...
        {
            if (strcmp(v[i].csuc, w[j].csuc) ==
                0) ///CONDICION QUE SE CUMPLE SII EXISTE UNA CUENTA INSCRITA EN UNA SUCURSAL
            {
                for (l = 0; l < a; l++) ///RECORRE EL VECTOR DE REGISTROS DE CLIENTES
                {
                    if (strcmp(v[i].ccli, y[l].cedula) ==
                        0) ///CONDICION QUE SE CUMPLE SII EXISTE UNA CUENTA QUE ESTA ASOCIADA A UN CLIENTE
                    {
                        for (m = 0; m < d; m++) ///RECORRE EL VECTOR DE REGISTRO DE LAS TRANSACCIONES
                        {
                            if (strcmp(v[i].ccta, x[m].ccta) ==
                                0) ///CONDICION QUE SE CUMPLE SII EXISTE UN ELEMENTO QUE PERTENECE AL
                            {
...
Busca_Cedula(cliente v[], int c, int* b, char ci[])
{
    ...
    *b = 0;
    ...
    {
        printf(ST LC
               RES"\t\t\t\tLa Cedula Introducida \"%s\", ya existe para otro Cliente\n", ci);
        printf("\t\t\t\tIntente de Nuevo con una Cedula de Identidad Distinta"CB
               LC"\n\n\n\n");
    }
}
Busca_Sucursal(rsucursal v[], int c, int* b, char cod[])
{
    ...
    *b = 0;
    ...
    if (*b > 1)
    {
        ...
        printf("\n\t\t  El Codigo de la Sucursal: \"%s\", ya existe para el Banco 100\x25 Universitario"CB
               LC"\n\n\n\n", cod);
    }
}
Busca_Cuenta(cuenta v[], int c, int* b, char cod[])
{
    ...
    *b = 0;
    ...
    if (*b > 1)
    {
        ...
        printf("\t\t\t\"%s\", es una cuenta existente en el Sistema Bancario"CB
               LC"\n\n\n\n", cod);
    }
}
Busca_Referencia(transaccion v[], int c, int* b, char ref[])
{
    ...
    *b = 0;
    ...
    {
        printf(ST LC
               RES"\t\t\t    Intente de Nuevo con un Codigo de Referencia de Transaccion\n");
    ...
    do
    {
        if (mod == 0)
        {
            ...
            do
            {
                ...
                {
                    printf(ST CR
                           "\t\t\tIngreso de Nombre del Cliente Incorrecto, Intente de Nuevo"CB"\n\n\n");
                }
            }
            ...
            do
            {
                ...
                if (v[*i].edo_civil != 'S' && v[*i].edo_civil != 'D' && v[*i].edo_civil != 'V'
                    && v[*i].edo_civil != 'O')
                {
                    printf(ST CR"\t\t\tOpcion Incorrecta, Intente de Nuevo"CB"\n\n\n");
                }
            }
            while (v[*i].edo_civil != 'S' && v[*i].edo_civil != 'D'
                   && v[*i].edo_civil != 'V' && v[*i].edo_civil != 'O');
...
Carga_Cuenta(cuenta v[], int* i, int mod)
{
    ...
    do
    {
        if (mod == 0)
        {
            ...
            CD(v[*i].faper.dia, v[*i].faper.mes, v[*i].faper.ano, v[*i].fupi.dia,
               v[*i].fupi.mes, v[*i].fupi.ano, &cant);
                      ...
                      rsucursal su[], int ccl, int ccu, int ctr, int csu)
{
    ...
    for (i = 0; i < csu; i++)
    {
        ...
        for (l = 0; l < ctr; l++)
        {
            for (j = 0; j < ccl; j++)
            {
                for (k = 0; k < ccu; k++)
                {
                    if (strcmp(su[i].csuc, tr[l].csuc) == 0
                        && strcmp(cl[j].cedula, cu[k].ccli) == 0 && strcmp(cu[k].ccta, tr[l].ccta) == 0)
                    {
                        if (ai == tr[l].ftrans.ano && mi == tr[l].ftrans.mes && di <= tr[l].ftrans.dia
                            && df >= tr[l].ftrans.dia)
                        {
                            if (b == 0)
                            {
                                ...
                                printf("----------------------------------------------------------------\n");
                                printf("\n\n\t\t| Cedula: %s \n\t\t| Nombre: %s\n\t\t| Apellido: %s",
                                       cl[j].cedula, cl[j].nombre, cl[j].apellido);
                                y = j;
                                bandera = 6;
                            }
    ...
    {
        printf(ST LC
               CAM"\t\t\t\tNO SE ENCONTRARON TRANSACCIONES REALIZADAS EN NINGUNA\n");
          ...
          int ctr)
{
    ...
    do
    {
        ...
        {
            printf(ST LC
                   CR"\t\tEl Dia Inicial no puede ser <<MAYOR>> que el Final, si los meses y años son iguales"CB
                   LC"\n\n\n");
        }

        if (af == ai && mi > mf)
        {
            printf(ST LC CR"\t\tEl Mes Inicial no puede ser <<MAYOR>> que el Final"CB
                   LC"\n\n\n");
        }

        if (ai > af)
        {
            printf(ST LC CR"\t\tEl Año Inicial no puede ser <<MAYOR>> que el Final"CB
                   LC"\n\n\n");
        }
    }
    ...
    for (j = 0; j < ccu; j++)
    {
        if ((ai == cu[j].fupi.ano && mi == cu[j].fupi.mes && di <= cu[j].fupi.dia)
            || (af == cu[j].fupi.ano && mf == cu[j].fupi.mes && df >= cu[j].fupi.dia))
        {
            ...
            if (cu[j].tcta == 'A' || cu[j].tcta == 'C')
            {
                if (cu[j].saldo >= 0)
                {
                    ...
                    printf("\t\t+"CV"\t - Ultima de Pago de Intereses: %.2d\x2F%.2d\x2F%d\n"CB"\t\t+",
                           cu[j].fupi.dia, cu[j].fupi.mes, cu[j].fupi.ano);
        ...
        else if ((ai == cu[j].fupi.ano && mi < cu[j].fupi.mes) && (af == cu[j].fupi.ano
                 && mf > cu[j].fupi.mes))
        {
            CD(cu[j].fupi.dia, cu[j].fupi.mes, cu[j].fupi.ano, df, mf, af, &dias);
...
ES_Cuentas(cuenta v[], int c)
{
    ...
    for (i = 0; i < c; i++)
    {
        ...
        fprintf(arch, "%s\n", v[i].ccta);
        fprintf(arch, "%c\n", v[i].tcta);
        fprintf(arch, "%.2d\x2F%.2d\x2F%d\n", v[i].faper.dia, v[i].faper.mes,
                v[i].faper.ano);
        fprintf(arch, "%.2d\x2F%.2d\x2F%d\n", v[i].fupi.dia, v[i].fupi.mes,
                v[i].fupi.ano);
        fprintf(arch, "%s\n\n", v[i].csuc);
    }
...
BAR(cliente cl[], cuenta cu[], transaccion tr[], int ccl, int ccu, int* ctr)
{
    ...
    for (i = 0; i < ccl; i++)
    {
        ...
        for (j = 0; j < ccl; j++)
        {
            for (k = 0; k < ccu; k++)
            {
                ...
                {
                    if (strcmp(cl[j].cedula, cu[k].ccli) == 0
                        && band == 0) //COMPARA LA CEDULA DEL CLIENTE REFERIDO CON SUS CUENTA
                    {
    ...
    if (ex == 2)
    {
        ...
        for (i = 0; i < ccl; i++)
        {
            ...
            {
                printf(LC RES
                       "\t\t\tSE HA DETECTADO QUE LA PERSONA CON C.I: %s, NO TIENE CUENTA Y,\n\t\t\t\tES POSIBLE BENEFICIARIO DEL B.A.R. (Bono Amigo Referido)",
                       cl[i].cedula);
                printf("\n\t\t\t\t->    Esto se verá reflejado en 'Clientes.out'    <-"CB
                       LC"\n\n");
            }
        }
...
main()
{
    ...
    int opc_men, opc_arc, opc_dat, opc_mod,
        opc_con; ///OPCION DE CADA MENU EN PARTICULAR
        ...
        switch (opc_men)
        {
                ...
                do
                {
                    ...
                    switch (opc_arc)
                    {
                        case 1:
                        {
                            ...
                            {
                                printf(LC CR"\t\tEl Archivo \"Sucursales.in\" se puede cargar solo una sola vez en la Ejecucion del Programa"CB
                                       LC"\n\n\n");
                                sleep(2);
                                opc = 'N';
                            }
                        ...
                        case 2:
                        {
                            ...
                            {
                                printf(LC CR"\t\tEl Archivo \"Clientes.in\" se puede cargar solo una sola vez en la Ejecucion del Programa"CB
                                       LC"\n\n\n");
                                sleep(2);
                                opc = 'N';
                            }
                        ...
                        case 3:
                        {
                            ...
                            {
                                printf(LC CR"\t\tEl Archivo \"Cuentas.in\" se puede cargar solo una sola vez en la Ejecucion del Programa"CB
                                       LC"\n\n\n");
                                sleep(2);
                                opc = 'N';
                            }
                        ...
                        case 4:
                        {
                            ...
                            {
                                printf(LC CR"\t\tEl Archivo \"Transacciones.in\" se puede cargar solo una sola vez en la Ejecucion del Programa"CB
                                       LC"\n\n\n");
                                sleep(2);
                                opc = 'N';
                            }
                ...
                do
                {
                    ...
                    switch (opc_dat)
                    {
                        case 1:
                        {
                            ...
                            {
                                printf(LC CR"\t\t\tSolo podrá hacer uso de esta funcion si y solo si ha cargado \"Sucursales.in\""CB
                                       LC"\n\n\n");
                                sleep(2);
                            }
                        }
                        ...
                        case 2:
                        {
                            ...
                            {
                                printf(LC CR"\t\t\tSolo podrá hacer uso de esta funcion si y solo si ha cargado \"Clientes.in\""CB
                                       LC"\n\n\n");
                                sleep(2);
                            }
                        }
                        ...
                        case 3:
                        {
                            ...
                            {
                                printf(LC CR"\t\t\tSolo podrá hacer uso de esta funcion si y solo si ha cargado \"Cuentas.in\""CB
                                       LC"\n\n\n");
                                sleep(2);
                            }
                        }
                        ...
                        case 4:
                        {
                            ...
                            {
                                printf(LC CR"\t\t\tSolo podrá hacer uso de esta funcion si y solo si ha cargado \"Transacciones.in\""CB
                                       LC"\n\n\n");
                                sleep(2);
                            }
                        }
                ...
                do
                {
                    ...
                    switch (opc_con)
                    {
                        case 1:
                        {
                            ...
                            {
                                printf(LC CR"\t\t\t\tNo Puede Consultar Sucursales sin haber cargado los datos en memoria"CB
                                       LC"\n\n\n");
                            }
                        }
                        break;
                        ...
                        case 2:
                        {
                            ...
                            {
                                printf(LC CR"\t\t\t\tNo Puede Consultar Clientes sin haber cargado los datos en memoria"CB
                                       LC"\n\n\n");
                            }
                        }
                        break;
                        ...
                        case 3:
                        {
                            ...
                            {
                                printf(LC CR"\t\t\t\tNo Puede Consultar Cuentas sin haber cargado los datos en memoria"CB
                                       LC"\n\n\n");
                            }
                        }
                        break;
                        ...
                        case 4:
                        {
                            ...
                            {
                                printf(LC CR"\t\t\t\tNo Puede Consultar Transacciones sin haber cargado los datos en memoria"CB
                                       LC"\n\n\n");
                            }
                        }
                        break;
            ...
            case 6: ///BONO AMIGO REFERIDO
            {
                do
                {
                    ...
                    {
                        printf(LC CR"\t\tLa Opcion BONO AMIGO REFERIDO se utiliza Solo una sola vez en la Ejecucion del Programa"CB
                               LC"\n\n\n");
                        opc = 'S';
                        sleep(5);
                    }
